...
public class ApiAccessKeyCredentials {
   ...
   public Builder toBuilder() {
      return new Builder().fromApiAccessKeyCredentials(this);
   }
   ...
   public static class Builder {
      ...
      public Builder fromApiAccessKeyCredentials(ApiAccessKeyCredentials in) {
         return this.accessKey(in.getAccessKey()).secretKey(in.getSecretKey());
      }
   }
